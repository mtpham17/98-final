...
k_gdp <- aov(GDP ~ cluster3, data = master_df_k)
k_pop <- aov(Pop ~ cluster3, data = master_df_k) 
k_exp <- aov(Expectancy ~ cluster3, data = master_df_k) 
k_fert <- aov(Fertility ~ cluster3, data = master_df_k) 
k_lit <- aov(literacy ~ cluster3, data = master_df_k) 
...
```{r}
h_gdp <- aov(GDP ~ cluster3, data = master_df_h)
h_pop <- aov(Pop ~ cluster3, data = master_df_h) 
h_exp <- aov(Expectancy ~ cluster3, data = master_df_h) 
h_fert <- aov(Fertility ~ cluster3, data = master_df_h) 
h_lit <- aov(literacy ~ cluster3, data = master_df_h) 
...
```{r}
rand.index(as.numeric(levels(master_df_k_continent$cluster3))[master_df_k_continent$cluster3], 
           master_df_k_continent$continent)
rand.index(as.numeric(levels(master_df_h_continent$cluster3))[master_df_h_continent$cluster3], 
           master_df_k_continent$continent)
rand.index(as.numeric(levels(master_df_h_continent$cluster3))[master_df_h_continent$cluster3], 
           as.numeric(levels(master_df_k_continent$cluster3))[master_df_k_continent$cluster3])
