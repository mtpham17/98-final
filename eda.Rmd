...
mod_df$POLICY_LENGTH <- (mod_df$POLICY_LENGTH - mean(mod_df$POLICY_LENGTH)) / 
  sd(mod_df$POLICY_LENGTH)
...
avg_dend_obj <- as.dendrogram(hclust_avg, h = 6, leaflab = "none")
...
```{r}
# some data cleaning on literacy rate lol rip :( need to note  
...
k_gdp <- aov(GDP ~ cluster6, data = master_df_k)
k_pop <- aov(Pop ~ cluster6, data = master_df_k) 
k_exp <- aov(Expectancy ~ cluster6, data = master_df_k) 
k_fert <- aov(Fertility ~ cluster6, data = master_df_k) 
k_lit <- aov(literacy ~ cluster6, data = master_df_k) 
...
```{r}
h_gdp <- aov(GDP ~ cluster6, data = master_df_h)
h_pop <- aov(Pop ~ cluster6, data = master_df_h) 
h_exp <- aov(Expectancy ~ cluster6, data = master_df_h) 
h_fert <- aov(Fertility ~ cluster6, data = master_df_h) 
h_lit <- aov(literacy ~ cluster6, data = master_df_h) 
...
```{r}
rand.index(as.numeric(levels(master_df_k_continent$cluster6))[master_df_k_continent$cluster6], 
           master_df_k_continent$continent)
rand.index(as.numeric(levels(master_df_h_continent$cluster6))[master_df_h_continent$cluster6], 
           master_df_k_continent$continent)
rand.index(as.numeric(levels(master_df_h_continent$cluster6))[master_df_h_continent$cluster6], 
           as.numeric(levels(master_df_k_continent$cluster6))[master_df_k_continent$cluster6])
rand.index(as.numeric(levels(master_df_k_hdi$cluster6))[master_df_k_hdi$cluster6], 
           master_df_k_hdi$development)
rand.index(as.numeric(levels(master_df_h_hdi$cluster6))[master_df_h_hdi$cluster6], 
...
p2 <- ggplot(master_df_k, aes(x = log(GDP), y = log(Pop), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(GDP), y = log(Expectancy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(GDP), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(GDP), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")
...
p2 <- ggplot(master_df_k, aes(x = log(Pop), y = log(Expectancy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(Pop), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(Pop), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(Expectancy), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_k, aes(x = log(Fertility), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")

#jpeg(file="kmeans_6.jpg")
# p2 <- ggplot(master_df_k, aes(x = log(Pop), y = log(Expectancy), color = cluster6)) + geom_point(size=2)
# p2 + ggtitle("K-Means: 6 Clusters") + scale_fill_brewer(palette="Set3")
#dev.off()

#jpeg(file="hac_6.jpg")
# p3 <- ggplot(master_df_h, aes(x = log(Pop), y = log(Expectancy), color = cluster6)) + geom_point(size=2) 
# p3 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")
#dev.off()
```

```{r}
p2 <- ggplot(master_df_h, aes(x = log(GDP), y = log(Pop), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(GDP), y = log(Expectancy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(GDP), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(GDP), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")
...
p2 <- ggplot(master_df_h, aes(x = log(Pop), y = log(Expectancy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(Pop), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(Pop), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(Expectancy), y = log(Fertility), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")

p2 <- ggplot(master_df_h, aes(x = log(Fertility), y = log(literacy), color = cluster6)) +
  geom_point(size=2)
p2 + ggtitle("HAC: 6 Clusters") + scale_fill_brewer(palette="Set3")
```
...
p <- ggplot(master_df_k, aes(x=cluster6, y=Expectancy, color = cluster6)) + 
  geom_boxplot()
p
dev.off()

jpeg(file="boxplot_hac_exp.jpg")
p <- ggplot(master_df_h, aes(x=cluster6, y=Expectancy, color = cluster6)) + 
  geom_boxplot()
p
dev.off()

jpeg(file="boxplot_k_fertility.jpg")
p <- ggplot(master_df_k, aes(x=cluster6, y=Fertility, color = cluster6)) + 
  geom_boxplot()
p
dev.off()

jpeg(file="boxplot_hac_fertility.jpg")
p <- ggplot(master_df_h, aes(x=cluster6, y=Fertility, color = cluster6)) + 
  geom_boxplot()
p
dev.off()
