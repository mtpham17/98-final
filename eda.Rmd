...
wss<- NULL
for (i in 1:15){
  fit = kmeans(by_country[,2:ncol(by_country)], centers = i, nstart = 5)
...
- officially decide on the number of clusters and linkage for HAC and K-means
...
- look at the natural way of clustering with clustering
