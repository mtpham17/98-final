...
```{r}
# data cleaning for NA values, mostly one-hot encoding
...
#jpeg(file="hac_6.jpg")
# p3 <- ggplot(master_df_h, aes(x = log(Pop), y = log(Expectancy), color = cluster)) + geom_point(size=2) 
...
```{r}
# manually label outliers for boxplots
